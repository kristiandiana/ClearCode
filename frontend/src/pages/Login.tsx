  ...
  return (
    <div className="min-h-screen flex flex-col gradient-bg relative overflow-hidden">
      ...
      <section className="flex flex-1 flex-col items-center justify-center px-4 py-24 text-center relative z-10">
        <div className="-mt-2 mb-8 animate-fade-in-up flex justify-center">
          <img src="/ClearCodeLogo.png" alt="ClearCode" className="h-28 sm:h-32 w-auto" />
        </div>
